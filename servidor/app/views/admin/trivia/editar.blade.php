	...
	<div class="span12">
		...
		<div class="widget-box">
			...
			<div class="widget-content nopadding">
				...
				{{ Form::open( array('url' => route('trivia_editar_post', $registro['id']), 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal') ) }} 
					...
					<div class="control-group {{ $errors->has( 'pregunta' ) ? 'error' : '' }}">
						...
						<div class="controls">
							...
							{{ Form::text( 'pregunta', Input::old( 'pregunta' ) != "" ? Input::old( 'pregunta' ):$registro['pregunta'] ) }} <br/>
