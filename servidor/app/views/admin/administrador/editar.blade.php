	...
	<div class="span12">
		...
		<div class="widget-box">
			...
			<div class="widget-content nopadding">
				...
				{{ Form::open( array('url' => route('usuario_editar_post', $registro['id']), 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal') ) }} 
					...
					<div class="control-group {{ $errors->has( 'perfil' ) ? 'error' : '' }}">
						...
						<div class="controls">
							...
							{{ Form::select('perfil_id', $perfiles, $registro['perfil_id'] ) }} <br/>
					...
					<div class="control-group {{ $errors->has( 'nombre' ) ? 'error' : '' }}">
						...
						<div class="controls">
							...
							{{ Form::text( 'nombre', $registro['nombre'] ) }} <br/>
					...
					<div class="control-group {{ $errors->has( 'apellido' ) ? 'error' : '' }}">
						...
						<div class="controls">
							...
							{{ Form::text( 'apellido', $registro['apellido'] ) }} <br/>
					...
					<div class="control-group {{ $errors->has( 'email' ) ? 'error' : '' }}">
						...
						<div class="controls">
							...
							{{ Form::text( 'email', $registro['email'] ) }} <br/>
					...
					<div class="control-group {{ $errors->has( 'celtrabajo' ) ? 'error' : '' }}">
						...
						<div class="controls">
							...
							{{ Form::text( 'celtrabajo', $registro['celtrabajo'] ) }} <br/>
					...
					<div class="control-group {{ $errors->has( 'active' ) ? 'error' : '' }}">
						...
						<div class="controls">
							...
							{{ Form::select('active', $estados, $registro['active'] ) }} <br/>
