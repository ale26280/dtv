...
<div class="widget-box">
	...
	<div class="widget-title">
		...
		<div class="buttons">
			<a title="Icon Title" class="btn btn-mini" href="{{ route('portfolio_agregar') }}"><i class="icon-plus"></i> Agregar nuevo</a>
				...
				<tr id="row_{{$registro['id']}}" class="odd_gradeA">
					...
					<td>
						<div class="btn-group">
							...
							<a href="{{ route('portfolio_editar', $registro['id']) }}" class="btn btn-mini" title="Editar/Actualizar Slider"><i class="icon-pencil"></i> </a>

							<a href="javascript:void%200;" class="btn btn-mini deleteModal" title="Eliminar Slider" data-element="row_{{$registro['id']}}" data-delete="{{ route('portfolio_borrar', $registro['id']) }}"><i class="icon-trash"></i> </a>
