	...
	<div class="span12">
		...
		<div class="widget-box">
			...
			<div class="widget-content nopadding">
				...
				{{ Form::open( array('url' => route('tag_agregar_post'), 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal') ) }} 
									
					<div class="control-group {{ $errors->has( 'tag' ) ? 'error' : '' }}">
					
						{{ Form::label('tag', 'Tag', array('class' => 'control-label')) }}
						
						<div class="controls">
						
							{{ Form::text( 'tag', Input::old( 'tag' ) != "" ? Input::old( 'tag' ):"" ) }} <br/>
