	...
	<div class="span12">
		...
		<div class="widget-box">
			...
			<div class="widget-content nopadding">
				...
				{{ Form::open( array('url' => route('memotest_editar_post', $registro['id']), 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal') ) }} 
					
					<div class="control-group {{ $errors->has( 'tema' ) ? 'error' : '' }}">
					
						{{ Form::label('tema', 'Eema', array('class' => 'control-label')) }}
					...
					<div class="control-group {{ $errors->has( 'img1' ) ? 'error' : '' }}">
						...
						<div class="controls">
							...
							@if ($registro['img1'] != "")
							<img id="img1" src="{{ URL::to('/') }}/script/timthumb.php?src=../storage/memotest/{{ $registro['img1'] }}&w=180" /><br/>
					...
					<div class="control-group {{ $errors->has( 'img2' ) ? 'error' : '' }}">
						...
						<div class="controls">
							...
							@if ($registro['img2'] != "")
							<img id="img1" src="{{ URL::to('/') }}/script/timthumb.php?src=../storage/memotest/{{ $registro['img2'] }}&w=180" /><br/>
