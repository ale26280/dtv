			...
			<div class="widget-content nopadding">
				...
				{{ Form::open( array('url' => route('newsletter_agregar_post'), 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal') ) }} 
					...
					<div class="control-group {{ $errors->has( 'nombre' ) ? 'error' : '' }}">
						...
						{{ Form::label('nombre', 'Nombre y apellido', array('class' => 'control-label')) }}
				...
				<div class="control-group {{ $errors->has( 'empresa' ) ? 'error' : '' }}">
						...
						<div class="controls">
							...
							{{ Form::text( 'empresa', Input::old( 'empresa' ) != "" ? Input::old( 'empresa' ):"" ) }} <br/>
				...
				<div class="control-group {{ $errors->has( 'color' ) ? 'error' : '' }}">
						...
						<div class="controls">
							...
							{{ Form::text( 'color', Input::old( 'color' ) != "" ? Input::old( 'color' ):"" ) }} <br/>
