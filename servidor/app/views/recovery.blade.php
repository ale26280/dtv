			...
			<div class="login">
				...
				<form method="post" action="javascript:void%200;" id="formReset">
					...
					<fieldset>
						...
						<a href="javascript:void%200;" title="Confirmar" id="btnResetConfirmar" data-reset="{{ route('reset_post') }}" class="boton" style="width:100px;">Confirmar</a>
			...
			<div class="modal-dialog modal-m">
				...
				<div class="modal-content">
					...
					<div class="modalContenido">
						...
						<a href="{{route('login')}}" class="boton">Aceptar</a>						
